...
class LightForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        user = kwargs.pop('user', None)  # Prinde utilizatorul curent din view, dacă este prezent
        super(LightForm, self).__init__(*args, **kwargs)
        # Dacă avem un utilizator, filtrăm camerele. Dacă nu, lăsăm toate camerele.
        if user:
...
class UserSettingsForm(forms.ModelForm):
    ...
    # Mută validarea în afara Meta class
